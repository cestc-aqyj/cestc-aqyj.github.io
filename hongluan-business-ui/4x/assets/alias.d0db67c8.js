...
<\/script>
`)],-1);function Z(n,o,e,d,r,p){const s=l("hb-demo0"),a=l("demo-block"),c=l("right-nav");return V(),L(S,null,[t("section",null,[Q,T,W,i(a,{fs:""},{source:_(()=>[i(s)]),highlight:_(()=>[U]),default:_(()=>[X]),_:1})]),i(c)],64)}var R=w(I,[["render",Z]]);export{R as default};
