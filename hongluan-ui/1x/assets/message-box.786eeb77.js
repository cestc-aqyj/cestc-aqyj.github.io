var H=Object.defineProperty;var k=Object.getOwnPropertySymbols;var T=Object.prototype.hasOwnProperty,v=Object.prototype.propertyIsEnumerable;var b=(n,e,o)=>e in n?H(n,e,{enumerable:!0,configurable:!0,writable:!0,value:o}):n[e]=o,m=(n,e)=>{for(var o in e||(e={}))T.call(e,o)&&b(n,o,e[o]);if(k)for(var o of k(e))v.call(e,o)&&b(n,o,e[o]);return n};import{Y as A,L as w,W as j,Q as u,a2 as a,a0 as s,P as L,aG as D,a3 as t,o as x}from"./vue.d40fa6f3.js";import{_ as V,H as f}from"./index.4c73e209.js";import{H as N}from"./hongluan-icons.ba2c1041.js";import"./hongluan.bb564fd4.js";import"./highlight.e2508551.js";const $={name:"component-doc",components:{"hl-demo0":function(){const{createTextVNode:n,resolveComponent:e,withCtx:o,openBlock:i,createBlock:C}=D,p=n("\u70B9\u51FB\u6253\u5F00 Message Box");function r(c,E){const h=e("hl-button");return i(),C(h,{type:"link",onClick:c.open},{default:o(()=>[p]),_:1},8,["onClick"])}const{defineComponent:F}=D,{HlMessageBox:d,HlMessage:l}=f,B=F({setup(){return{open:()=>{d.alert("\u8FD9\u662F\u4E00\u6BB5\u5185\u5BB9","\u6807\u9898\u540D\u79F0",{confirmButtonText:"\u786E\u5B9A",callback:E=>{l({type:"info",message:`action: ${E}`})}})}}}});return m({render:r},B)}(),"hl-demo1":function(){const{createTextVNode:n,resolveComponent:e,withCtx:o,openBlock:i,createBlock:C}=D,p=n("\u70B9\u51FB\u6253\u5F00 Message Box");function r(c,E){const h=e("hl-button");return i(),C(h,{type:"link",onClick:c.open},{default:o(()=>[p]),_:1},8,["onClick"])}const{defineComponent:F}=D,{HlMessageBox:d,HlMessage:l}=f,B=F({setup(){return{open:()=>{d.confirm("\u6B64\u64CD\u4F5C\u5C06\u6C38\u4E45\u5220\u9664\u8BE5\u6587\u4EF6, \u662F\u5426\u7EE7\u7EED?","\u63D0\u793A",{confirmButtonText:"\u786E\u5B9A",confirmButtonType:"danger",cancelButtonText:"\u53D6\u6D88",type:"success"}).then(()=>{l({type:"success",message:"\u5220\u9664\u6210\u529F!"})}).catch(()=>{l({type:"info",message:"\u5DF2\u53D6\u6D88\u5220\u9664"})})}}}});return m({render:r},B)}(),"hl-demo2":function(){const{createTextVNode:n,resolveComponent:e,withCtx:o,openBlock:i,createBlock:C}=D,p=n("\u70B9\u51FB\u6253\u5F00 Message Box");function r(M,_){const g=e("hl-button");return i(),C(g,{type:"link",onClick:M.open},{default:o(()=>[p]),_:1},8,["onClick"])}const{defineComponent:F,h:d}=D,{HlMessageBox:l,HlMessage:B,HlIcon:c}=f,{TwoAirplay:E}=N,h=F({setup(){return{open:()=>{l({title:"\u6D88\u606F",message:d("p",null,[d("span",null,"\u5185\u5BB9\u53EF\u4EE5\u662F "),d("i",{style:"color: teal"},"VNode")]),icon:d(c,{size:"xl"},[d(E)]),showCancelButton:!0,confirmButtonText:"\u786E\u5B9A",cancelButtonText:"\u53D6\u6D88",beforeClose:(_,g,y)=>{_==="confirm"?(g.confirmButtonLoading=!0,g.confirmButtonText="\u6267\u884C\u4E2D...",setTimeout(()=>{y(),setTimeout(()=>{g.confirmButtonLoading=!1},300)},3e3)):y()}}).then(_=>{B({type:"info",message:"action: "+_})})}}}});return m({render:r},h)}(),"hl-demo3":function(){const{createTextVNode:n,resolveComponent:e,withCtx:o,openBlock:i,createBlock:C}=D,p=n("\u70B9\u51FB\u6253\u5F00 Message Box");function r(B,c){const E=e("hl-button");return i(),C(E,{type:"link",onClick:B.open},{default:o(()=>[p]),_:1},8,["onClick"])}const{defineComponent:F}=D,{HlMessageBox:d}=f,l=F({setup(){return{open:()=>{d.alert("<strong>\u8FD9\u662F <i>HTML</i> \u7247\u6BB5</strong>","HTML \u7247\u6BB5",{dangerouslyUseHTMLString:!0})}}}});return m({render:r},l)}(),"hl-demo4":function(){const{createTextVNode:n,resolveComponent:e,withCtx:o,openBlock:i,createBlock:C}=D,p=n("\u70B9\u51FB\u6253\u5F00 Message Box");function r(c,E){const h=e("hl-button");return i(),C(h,{type:"link",onClick:c.open},{default:o(()=>[p]),_:1},8,["onClick"])}const{defineComponent:F}=D,{HlMessageBox:d,HlMessage:l}=f,B=F({setup(){return{open:()=>{d.confirm("\u68C0\u6D4B\u5230\u672A\u4FDD\u5B58\u7684\u5185\u5BB9\uFF0C\u662F\u5426\u5728\u79BB\u5F00\u9875\u9762\u524D\u4FDD\u5B58\u4FEE\u6539\uFF1F","\u786E\u8BA4\u4FE1\u606F",{distinguishCancelAndClose:!0,confirmButtonText:"\u4FDD\u5B58",cancelButtonText:"\u653E\u5F03\u4FEE\u6539"}).then(()=>{l({type:"info",message:"\u4FDD\u5B58\u4FEE\u6539"})}).catch(E=>{l({type:"info",message:E==="cancel"?"\u653E\u5F03\u4FDD\u5B58\u5E76\u79BB\u5F00\u9875\u9762":"\u505C\u7559\u5728\u5F53\u524D\u9875\u9762"})})}}}});return m({render:r},B)}()}},S=u("h1",null,"MessageBox \u5F39\u6846",-1),P=u("p",null,"\u6A21\u62DF\u7CFB\u7EDF\u7684\u6D88\u606F\u63D0\u793A\u6846\u800C\u5B9E\u73B0\u7684\u4E00\u5957\u6A21\u6001\u5BF9\u8BDD\u6846\u7EC4\u4EF6\uFF0C\u7528\u4E8E\u6D88\u606F\u63D0\u793A\u3001\u786E\u8BA4\u6D88\u606F\u548C\u63D0\u4EA4\u5185\u5BB9\u3002",-1),q=u("div",{class:"doc-tip"},[u("p",null,[t("\u4ECE\u573A\u666F\u4E0A\u8BF4\uFF0CMessageBox \u7684\u4F5C\u7528\u662F\u7F8E\u5316\u7CFB\u7EDF\u81EA\u5E26\u7684 "),u("code",null,"alert"),t("\u548C"),u("code",null,"confirm"),t("\uFF0C\u56E0\u6B64\u9002\u5408\u5C55\u793A\u8F83\u4E3A\u7B80\u5355\u7684\u5185\u5BB9\u3002\u5982\u679C\u9700\u8981\u5F39\u51FA\u8F83\u4E3A\u590D\u6742\u7684\u5185\u5BB9\uFF0C\u8BF7\u4F7F\u7528 Dialog\u3002")])],-1),I=u("h2",{id:"xiao-xi-ti-shi"},[u("a",{class:"header-anchor",href:"#xiao-xi-ti-shi"}),t(" \u6D88\u606F\u63D0\u793A")],-1),z=u("p",null,"\u5F53\u7528\u6237\u8FDB\u884C\u64CD\u4F5C\u65F6\u4F1A\u88AB\u89E6\u53D1\uFF0C\u8BE5\u5BF9\u8BDD\u6846\u4E2D\u65AD\u7528\u6237\u64CD\u4F5C\uFF0C\u76F4\u5230\u7528\u6237\u786E\u8BA4\u77E5\u6653\u540E\u624D\u53EF\u5173\u95ED\u3002",-1),U=u("div",null,[u("p",null,[t("\u8C03\u7528"),u("code",null,"$alert"),t("\u65B9\u6CD5\u5373\u53EF\u6253\u5F00\u6D88\u606F\u63D0\u793A\uFF0C\u5B83\u6A21\u62DF\u4E86\u7CFB\u7EDF\u7684 "),u("code",null,"alert"),t("\uFF0C\u65E0\u6CD5\u901A\u8FC7\u6309\u4E0B ESC \u6216\u70B9\u51FB\u6846\u5916\u5173\u95ED\u3002\u6B64\u4F8B\u4E2D\u63A5\u6536\u4E86\u4E24\u4E2A\u53C2\u6570\uFF0C"),u("code",null,"message"),t("\u548C"),u("code",null,"title"),t("\u3002\u503C\u5F97\u4E00\u63D0\u7684\u662F\uFF0C\u7A97\u53E3\u88AB\u5173\u95ED\u540E\uFF0C\u5B83\u9ED8\u8BA4\u4F1A\u8FD4\u56DE\u4E00\u4E2A"),u("code",null,"Promise"),t("\u5BF9\u8C61\u4FBF\u4E8E\u8FDB\u884C\u540E\u7EED\u64CD\u4F5C\u7684\u5904\u7406\u3002\u82E5\u4E0D\u786E\u5B9A\u6D4F\u89C8\u5668\u662F\u5426\u652F\u6301"),u("code",null,"Promise"),t("\uFF0C\u53EF\u81EA\u884C\u5F15\u5165\u7B2C\u4E09\u65B9 polyfill \u6216\u50CF\u672C\u4F8B\u4E00\u6837\u4F7F\u7528\u56DE\u8C03\u8FDB\u884C\u540E\u7EED\u5904\u7406\u3002")])],-1),O=u("pre",null,[u("code",{class:"html"},` <template>
  ...
  setup() {
    const open = () => {
      HlMessageBox({
        ...
        icon: h(HlIcon, { size: 'xl' }, [h(TwoAirplay)]),
...
<\/script>
`)],-1),su={id:"app-shang-xia-wen-ji-cheng-1.5.7"},Fu=u("a",{class:"header-anchor",href:"#app-shang-xia-wen-ji-cheng-1.5.7"},null,-1),du=t(" App \u4E0A\u4E0B\u6587\u7EE7\u627F "),lu=t("> 1.5.7"),cu=x(`<div class="doc-tip"><p>\u5982\u679C\u5168\u5C40\u6CE8\u518C HlMessageBox \u7EC4\u4EF6, \u4F1A\u81EA\u52A8\u7EE7\u627Fapp\u4E0A\u4E0B\u6587\u4FE1\u606F\u3002</p></div><pre><code class="hljs language-ts"><span class="hljs-keyword">import</span> { getCurrentInstance } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
<span class="hljs-keyword">import</span> { HlMessageBox } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;hongluan-ui&#39;</span>
...
HlMessageBox.alert(<span class="hljs-string">&#39;Hello world!&#39;</span>, <span class="hljs-string">&#39;Title&#39;</span>, {}, appContext)
