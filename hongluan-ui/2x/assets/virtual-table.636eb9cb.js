...
<\/script>
`},null,8,["demos"]),R,L,x(a,{fs:"",demos:D(n),"path-name":"virtual-table/loading","source-code":`<template>
  <hl-virtual-table
    :cols="cols"
    :data="tableData"
    :total="200"
...
<\/script>
`},null,8,["demos"]),V]),x(l)],64)}}};export{$ as default};
