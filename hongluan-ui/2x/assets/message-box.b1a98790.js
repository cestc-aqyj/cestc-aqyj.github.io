...
<\/script>
`},{default:a(()=>[U]),_:1},8,["demos"]),X,J,c(n,{fs:"",demos:g(s),"path-name":"message-box/confirm","source-code":`<template>
  <hl-button type="link" @click="open">\u70B9\u51FB\u6253\u5F00 Message Box</hl-button>
</template>
...
<\/script>
`},{default:a(()=>[Q]),_:1},8,["demos"]),W,Y,c(n,{fs:"",demos:g(s),"path-name":"message-box/custom","source-code":`<template>
  <hl-button type="link" @click="open">\u70B9\u51FB\u6253\u5F00 Message Box</hl-button>
</template>
...
`},{default:a(()=>[G]),_:1},8,["demos"]),K,c(n,{fs:"",demos:g(s),"path-name":"message-box/html","source-code":`<template>
  <hl-button type="link" @click="open">\u70B9\u51FB\u6253\u5F00 Message Box</hl-button>
</template>
...
<\/script>
`},{default:a(()=>[R]),_:1},8,["demos"]),Z,c(n,{fs:"",demos:g(s),"path-name":"message-box/cancel-close","source-code":`<template>
  <hl-button type="link" @click="open">\u70B9\u51FB\u6253\u5F00 Message Box</hl-button>
</template>
...
<\/script>
`},{default:a(()=>[tt]),_:1},8,["demos"]),t("h2",et,[nt,st,c(B,null,{default:a(()=>[ot]),_:1})]),at]),c(x)],64)}}};export{rt as default};
