...
<\/script>
`},{default:t(()=>[qt,Nt]),_:1},8,["demos"]),Jt,Kt,e(o,{fs:"",demos:s(a),"path-name":"menu/sidebar","source-code":`<template>
  <hl-row>
    <hl-col :span="12">
      <hl-menu
        default-active="2"
...
<\/script>
`},{default:t(()=>[Zt,te]),_:1},8,["demos"]),ee,ne,e(o,{fs:"",demos:s(a),"path-name":"menu/collapse","source-code":`<template>
...
`},{default:t(()=>[de,le]),_:1},8,["demos"]),ue]),e(d)],64)}}};export{ae as default};
