...
<\/script>
`},{default:o(()=>[q,z]),_:1},8,["demos"]),j,O,n(r,{fs:"",demos:c(e),"path-name":"time-picker/is-range","source-code":`<template>
  <hl-row align="items-center" gap="var(--xl)">
    <hl-col span="lg:col-10">
      <hl-time-picker
        v-model="value2"
...
<\/script>
`},{default:o(()=>[U]),_:1},8,["demos"]),N]),n(i)],64)}}};export{W as default};
