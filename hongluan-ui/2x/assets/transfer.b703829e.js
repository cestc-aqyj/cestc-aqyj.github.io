...
<\/script>
`},{default:a(()=>[tt]),_:1},8,["demos"]),et,l(d,{fs:"",demos:_(f),"path-name":"transfer/show-buttons","source-code":`<template>
  <hl-transfer
    v-model="value"
...
const value = ref([1, 4])
<\/script>
`},{default:a(()=>[nt]),_:1},8,["demos"]),dt,at,l(d,{fs:"",demos:_(f),"path-name":"transfer/filterable","source-code":`<template>
...
<\/script>
`},{default:a(()=>[lt]),_:1},8,["demos"]),ot,rt,l(d,{fs:"",demos:_(f),"path-name":"transfer/slot","source-code":`<template>
  <hl-row>
...
`},{default:a(()=>[st]),_:1},8,["demos"]),ut,ct,l(d,{fs:"",demos:_(f),"path-name":"transfer/props","source-code":`<template>
  <hl-transfer
    v-model="value"
    :props="{
      key: 'value',
...
<\/script>
`},{default:a(()=>[ht]),_:1},8,["demos"]),it]),l(n)],64)}}};export{_t as default};
