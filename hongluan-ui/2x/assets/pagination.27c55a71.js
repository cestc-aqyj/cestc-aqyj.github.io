...
`},{default:s(()=>[de]),_:1},8,["demos"]),re,se,l(r,{fs:"",demos:v(a),"path-name":"pagination/pager-count","source-code":`<template>
  <hl-pagination
    :page-size="20"
    :pager-count="11"
...
`},{default:s(()=>[ie]),_:1},8,["demos"]),ce,ue,l(r,{fs:"",demos:v(a),"path-name":"pagination/size","source-code":`<template>
...
<\/script>
`},{default:s(()=>[pe]),_:1},8,["demos"]),ge,_e,l(r,{fs:"",demos:v(a),"path-name":"pagination/gap","source-code":`<template>
...
<\/script>
`},{default:s(()=>[he]),_:1},8,["demos"]),me,ve,l(r,{fs:"",demos:v(a),"path-name":"pagination/line","source-code":`<template>
  <hl-pagination line layout="prev, pager, next" :total="50" />
</template>
`},null,8,["demos"]),be,fe,l(r,{fs:"",demos:v(a),"path-name":"pagination/block","source-code":`<template>
  <hl-pagination block layout="prev, pager, next" :total="50" />
</template>
`},null,8,["demos"]),xe,ye,l(r,{fs:"",demos:v(a),"path-name":"pagination/align","source-code":`<template>
...
`},null,8,["demos"]),ze,ke,l(r,{fs:"",demos:v(a),"path-name":"pagination/extra","source-code":`<template>
  <hl-row>
...
<\/script>
`},{default:s(()=>[Se]),_:1},8,["demos"]),we,Ve,l(r,{fs:"",demos:v(a),"path-name":"pagination/single-page","source-code":`<template>
  <div>
    <p class="m-b-md">
...
<\/script>
`},null,8,["demos"]),je]),l(c)],64)}}};export{Te as default};
