...
</code></pre>`,1),O=n(" v2x \u7248\u672C config.scss "),J=o(`<pre><code class="hljs language-scss"><span class="hljs-variable">$conf_tag</span>: (
...
</code></pre><h2 id="chi-cun-bian-liang-xiu-gai"><a class="header-anchor" href="#chi-cun-bian-liang-xiu-gai"></a> \u5C3A\u5BF8\u53D8\u91CF\u4FEE\u6539</h2><p>\u5C3A\u5BF8\u53D8\u91CF\u4E0D\u518D\u4F7F\u7528<code>scss\u53D8\u91CF</code>\u65B9\u5F0F\uFF0C\u53D6\u800C\u4EE3\u4E4B\u7684\u662F <code>css var()</code>\u53D8\u91CF</p>`,3),pu=n(" $md "),cu=n(" var(--md) ");function iu(r,t,l,g,F,m){const a=h("hl-tag"),B=h("hl-demo0"),b=h("demo-block"),p=h("TwoArrowRight"),c=h("hl-icon"),i=h("hl-group"),d=h("right-nav");return z(),q(k,null,[e("section",null,[S,N,H,u(a,{type:"danger",effect:"light",class:"border-none border-left border-danger m-b-sm",style:{"--border-left-width":"4px"}},{default:s(()=>[I]),_:1}),M,u(a,{type:"danger",effect:"light",class:"border-none border-left border-danger m-b-sm",style:{"--border-left-width":"4px"}},{default:s(()=>[P]),_:1}),R,u(a,{type:"danger",effect:"light",class:"border-none border-left border-danger m-b-sm",style:{"--border-left-width":"4px"}},{default:s(()=>[T]),_:1}),L,u(b,{"source-code":`<hl-button
  style="
    --button-radius: 8px;
    --button-padding-x: 20px;
    --button-padding-y: 4px;
