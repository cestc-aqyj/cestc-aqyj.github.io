...
<\/script>
`},{default:d(()=>[tt]),_:1},8,["demos"]),et,l(a,{fs:"",demos:_(f),"path-name":"transfer/show-buttons","source-code":`<template>
  <hl-transfer
    v-model="value"
...
const value = ref([1, 4])
<\/script>
`},{default:d(()=>[nt]),_:1},8,["demos"]),at,dt,l(a,{fs:"",demos:_(f),"path-name":"transfer/filterable","source-code":`<template>
...
<\/script>
`},{default:d(()=>[lt]),_:1},8,["demos"]),ot,rt,l(a,{fs:"",demos:_(f),"path-name":"transfer/slot","source-code":`<template>
  <hl-row>
...
`},{default:d(()=>[st]),_:1},8,["demos"]),ut,ct,l(a,{fs:"",demos:_(f),"path-name":"transfer/props","source-code":`<template>
  <hl-transfer
    v-model="value"
    :props="{
      key: 'value',
