...
<\/script>
`},{default:o(()=>[N,Y]),_:1},8,["demos"]),O,d(a,{fs:"",demos:f(u),"path-name":"datetime-picker/datetimerange","source-code":`<template>
...
<\/script>
`},{default:o(()=>[R,H]),_:1},8,["demos"]),L,d(a,{fs:"",demos:f(u),"path-name":"datetime-picker/default-time","source-code":`<template>
  <hl-row align="items-center" gap="var(--lg)">
    <hl-col span="col">
...
<\/script>
`},{default:o(()=>[Q,W]),_:1},8,["demos"]),X]),d(e)],64)}}};export{I as default};
