...
<\/script>
`)],-1),G=u("h2",{id:"message-xiang-guan-pei-zhi"},[u("a",{class:"header-anchor",href:"#message-xiang-guan-pei-zhi"}),x(" Message \u76F8\u5173\u914D\u7F6E")],-1),I=u("pre",null,[u("code",{class:"html"},` <template>
  <div>
