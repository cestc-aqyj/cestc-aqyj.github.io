...
<\/script>
`},{default:a(()=>[R]),_:1},8,["demos"]),L,V,x(l,{fs:"",demos:D(n),"path-name":"virtual-table/loading","source-code":`<template>
  <hl-virtual-table
    :cols="cols"
    :data="tableData"
    :total="200"
...
<\/script>
`},{default:a(()=>[M]),_:1},8,["demos"]),$]),x(s)],64)}}};export{Q as default};
