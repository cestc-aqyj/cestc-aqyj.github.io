...
<\/script>
`)],-1),P=t("h2",{id:"yin-cang-duo-yu-biao-qian-de-duo-xuan"},[t("a",{class:"header-anchor",href:"#yin-cang-duo-yu-biao-qian-de-duo-xuan"}),p(" \u9690\u85CF\u591A\u4F59\u6807\u7B7E\u7684\u591A\u9009")],-1),K=t("pre",null,[t("code",{class:"html"},`<template>
  <hl-select-v2
    v-model="value"
    :options="options"
    placeholder="\u8BF7\u9009\u62E9"
...
<\/script>
`)],-1),G=t("h2",{id:"ke-shai-xuan-de-duo-xuan"},[t("a",{class:"header-anchor",href:"#ke-shai-xuan-de-duo-xuan"}),p(" \u53EF\u7B5B\u9009\u7684\u591A\u9009")],-1),J=t("p",null,"\u5F53\u9009\u9879\u8FC7\u591A\u65F6\uFF0C\u53EF\u901A\u8FC7\u5339\u914D\u7B5B\u9009",-1),Q=t("pre",null,[t("code",{class:"html"},`<template>
  <hl-select-v2
    v-model="value"
    filterable
    :options="options"
