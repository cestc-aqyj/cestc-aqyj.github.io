...
<\/script>
`)],-1),Y=e("h2",{id:"ju-zhong-pai-lie-fang-shi"},[e("a",{class:"header-anchor",href:"#ju-zhong-pai-lie-fang-shi"}),s(" \u5C45\u4E2D\u6392\u5217\u65B9\u5F0F")],-1),Z=e("p",null,[s("\u4E3A Timeline \u7EC4\u4EF6\u8BBE\u7F6E "),e("code",null,"center"),s(" \u5C5E\u6027\uFF0C\u53EF\u4F7F\u65F6\u95F4\u8F74\u5C45\u4E2D\u6446\u653E\u3002")],-1),tt=e("div",null,[e("p",null,[s("\u540C\u65F6\u4F1A\u4E3A TimelineItem \u521B\u5EFA\u4E00\u4E2A class \u4E3A"),e("code",null,"item-left"),s("\u7684 DOM \u8282\u70B9\u6765\u4FDD\u6301\u5C45\u4E2D\u7684\u6548\u679C\u3002")])],-1),et=e("pre",null,[e("code",{class:"html"},` <template>
  <hl-row>
    <hl-col class="col">
...
<\/script>
`)],-1),nt=e("h2",{id:"ding-yi-jie-dian-yang-shi"},[e("a",{class:"header-anchor",href:"#ding-yi-jie-dian-yang-shi"}),s(" \u2F83\u5B9A\u4E49\u8282\u70B9\u6837\u5F0F")],-1),ut=e("p",null,"\u53EF\u6839\u636E\u5B9E\u9645\u573A\u666F\u2F83\u5B9A\u4E49\u8282\u70B9\u989C\u2F8A\uFF0C\u6216\u76F4\u63A5\u4F7F\u2F64\u56FE\u6807\u3002",-1),it=e("pre",null,[e("code",{class:"html"},` <template>
  <div class="block">
    <hl-timeline>
      <hl-timeline-item
...
<\/script>
`)],-1),lt=e("h2",{id:"cha-cao"},[e("a",{class:"header-anchor",href:"#cha-cao"}),s(" \u63D2\u69FD")],-1),ot=e("p",null,[s("\u65F6\u95F4\u8F74\u63D0\u4F9B"),e("code",null,"default"),s(),e("code",null,"dot"),s(),e("code",null,"label"),s("\u4E09\u4E2A\u63D2\u69FD\u7528\u4E8E\u81EA\u5B9A\u4E49\u6837\u5F0F")],-1),ct=e("pre",null,[e("code",{class:"html"},` <template>
  <div class="block">
    <hl-timeline>
      <hl-timeline-item :hide-timestamp="true" timestamp="2021/7/12">
        <template #label>
          2021/7/12
        </template>
        <hl-panel>
...
`)],-1),at=W('<h2 id="attributes"><a class="header-anchor" href="#attributes"></a> Attributes</h2><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u53EF\u9009\u503C</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>center</td><td>\u662F\u5426\u65F6\u95F4\u8F74\u5C45\u4E2D\u663E\u793A</td><td>boolean</td><td>-</td><td>false</td></tr><tr><td>alternate</td><td>\u662F\u5426\u81EA\u52A8\u5DE6\u53F3\u4EA4\u66FF\u663E\u793A\u5185\u5BB9</td><td>boolean</td><td>\u2014</td><td>false</td></tr></tbody></table><h2 id="timeline-item-attributes"><a class="header-anchor" href="#timeline-item-attributes"></a> Timeline Item Attributes</h2><table><thead><tr><th>\u53C2\u6570</th><th>\u8BF4\u660E</th><th>\u7C7B\u578B</th><th>\u53EF\u9009\u503C</th><th>\u9ED8\u8BA4\u503C</th></tr></thead><tbody><tr><td>timestamp</td><td>\u65F6\u95F4\u6233</td><td>string</td><td>-</td><td>\u2014</td></tr><tr><td>hide-timestamp</td><td>\u662F\u5426\u9690\u85CF\u65F6\u95F4\u6233</td><td>boolean</td><td>\u2014</td><td>false</td></tr><tr><td>type</td><td>\u8282\u70B9\u7C7B\u578B</td><td>string</td><td>primary / success / warning / danger / info</td><td>-</td></tr><tr><td>color</td><td>\u8282\u70B9\u989C\u8272</td><td>string</td><td>hsl / hsv / hex / rgb</td><td>-</td></tr><tr><td>icon</td><td>\u8282\u70B9\u56FE\u6807</td><td>object</td><td>\u53C2\u89C1 Icon \u7EC4\u4EF6\u5C5E\u6027</td><td>-</td></tr><tr><td>dir</td><td>\u8282\u70B9\u4F4D\u7F6E</td><td>string</td><td>left / right</td><td>right</td></tr></tbody></table><h2 id="timeline-item-slots"><a class="header-anchor" href="#timeline-item-slots"></a> Timeline Item Slots</h2><table><thead><tr><th>name</th><th>\u8BF4\u660E</th></tr></thead><tbody><tr><td>\u2014</td><td>Timeline-Item \u7684\u5185\u5BB9</td></tr><tr><td>dot</td><td>\u81EA\u5B9A\u4E49\u8282\u70B9\uFF0C\u4F18\u5148\u7EA7\u9AD8\u4E8Eicon</td></tr><tr><td>label</td><td>\u81EA\u5B9A\u4E49\u8282\u70B9</td></tr><tr><td>icon</td><td>\u81EA\u5B9A\u4E49\u56FE\u6807</td></tr></tbody></table>',6);function mt(l,n,t,u,c,F){const a=w("hl-demo0"),i=w("demo-block"),o=w("hl-demo1"),m=w("hl-demo2"),d=w("hl-demo3"),E=w("right-nav");return M(),H("section",K,[e("div",P,[Q,R,v(i,{fs:""},{source:f(()=>[v(a)]),highlight:f(()=>[X]),default:f(()=>[U]),_:1}),Y,Z,v(i,{fs:""},{source:f(()=>[v(o)]),highlight:f(()=>[et]),default:f(()=>[tt]),_:1}),nt,ut,v(i,{fs:""},{source:f(()=>[v(m)]),highlight:f(()=>[it]),_:1}),lt,ot,v(i,{fs:""},{source:f(()=>[v(d)]),highlight:f(()=>[ct]),_:1}),at]),v(E)])}var Ft=q(J,[["render",mt]]);export{Ft as default};
