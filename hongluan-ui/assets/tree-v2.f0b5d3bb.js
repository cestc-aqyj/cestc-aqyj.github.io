var v=Object.defineProperty;var K=Object.getOwnPropertySymbols;var M=Object.prototype.hasOwnProperty,w=Object.prototype.propertyIsEnumerable;var N=(s,o,c)=>o in s?v(s,o,{enumerable:!0,configurable:!0,writable:!0,value:c}):s[o]=c,_=(s,o)=>{for(var c in o||(o={}))M.call(o,c)&&N(s,c,o[c]);if(K)for(var c of K(o))w.call(o,c)&&N(s,c,o[c]);return s};import{H as b,o as T,C as $,D as u,v as F,M as p,av as y,_ as B,au as j}from"./vue.450bc1d0.js";import{_ as V}from"./index.fedb9125.js";import"./hongluan.5b0660e6.js";import"./highlight.e2508551.js";import"./hongluan-icons.7d79c200.js";const q={name:"component-doc",components:{"hl-demo0":function(){const{resolveComponent:s,openBlock:o,createBlock:c}=y;function f(e,r){const t=s("hl-tree-v2");return o(),c(t,{data:e.data,props:e.props,height:208},null,8,["data","props"])}const{defineComponent:C,ref:D}=y,m=(e,r)=>`${e}-${r}`,a=(e,r,t,d=1,n="node")=>{let i=0;return new Array(t).fill(d).map(()=>{const h=d===e?0:Math.round(Math.random()*r),l=m(n,++i);return{id:l,label:l,children:h?a(e,r,h,d+1,l):void 0}})},E=C({setup(){return{data:a(4,30,40),props:D({id:"id",label:"label",children:"children"})}}});return _({render:f},E)}(),"hl-demo1":function(){const{resolveComponent:s,openBlock:o,createBlock:c}=y;function f(e,r){const t=s("hl-tree-v2");return o(),c(t,{data:e.data,props:e.props,"show-checkbox":"",height:208},null,8,["data","props"])}const{defineComponent:C,ref:D}=y,m=(e,r)=>`${e}-${r}`,a=(e,r,t,d=1,n="node")=>{let i=0;return new Array(t).fill(d).map(()=>{const h=d===e?0:Math.round(Math.random()*r),l=m(n,++i);return{id:l,label:l,children:h?a(e,r,h,d+1,l):void 0}})},E=C({setup(){return{data:a(4,30,40),props:D({id:"id",label:"label",children:"children"})}}});return _({render:f},E)}(),"hl-demo2":function(){const{resolveComponent:s,openBlock:o,createBlock:c}=y;function f(e,r){const t=s("hl-tree-v2");return o(),c(t,{data:e.data,props:e.props,"show-checkbox":"",height:208},null,8,["data","props"])}const{defineComponent:C,ref:D}=y,m=(e,r)=>`${e}-${r}`,a=(e,r,t,d=1,n="node")=>{let i=0;return new Array(t).fill(d).map(()=>{const h=d===e?0:Math.round(Math.random()*r),l=m(n,++i);return{id:l,label:l,disabled:Math.random()>.6,children:h?a(e,r,h,d+1,l):void 0}})},E=C({setup(){return{data:a(4,30,40),props:D({id:"id",label:"label",children:"children",disabled:"disabled"})}}});return _({render:f},E)}(),"hl-demo3":function(){const{resolveComponent:s,openBlock:o,createBlock:c}=y;function f(e,r){const t=s("hl-tree-v2");return o(),c(t,{data:e.data,height:208,props:e.props,"show-checkbox":"","default-checked-keys":e.defaultCheckedKeys,"default-expanded-keys":e.defaultExpandedKeys},null,8,["data","props","default-checked-keys","default-expanded-keys"])}const{defineComponent:C,ref:D}=y,m=(e,r)=>`${e}-${r}`,a=(e,r,t,d=1,n="node")=>{let i=0;return new Array(t).fill(d).map(()=>{const h=d===e?0:Math.round(Math.random()*r),l=m(n,++i);return{id:l,label:l,children:h?a(e,r,h,d+1,l):void 0}})},E=C({setup(){const e=a(4,30,40),r=[],t=[];for(let d=0;d<e.length;++d){const n=e[d].children;if(n){t.push(e[d].id),r.push(n[0].id);break}}return{data:e,props:D({id:"id",label:"label",children:"children"}),defaultCheckedKeys:r,defaultExpandedKeys:t}}});return _({render:f},E)}(),"hl-demo4":function(){const{normalizeClass:s,createElementVNode:o,toDisplayString:c,resolveComponent:f,withCtx:C,openBlock:D,createBlock:m}=y;function a(n,i){const h=f("hl-tree-v2");return D(),m(h,{data:n.data,props:n.props,height:208},{default:C(({node:l})=>[o("span",{class:s(["prefix text-primary",{"is-leaf":l.isLeaf}])},"TreeV2\xA0\xA0",2),o("span",null,c(l.label),1)]),_:1},8,["data","props"])}const{defineComponent:E,ref:e}=y,r=(n,i)=>`${n}-${i}`,t=(n,i,h,l=1,k="node")=>{let A=0;return new Array(h).fill(l).map(()=>{const x=l===n?0:Math.round(Math.random()*i),g=r(k,++A);return{id:g,label:g,children:x?t(n,i,x,l+1,g):void 0}})},d=E({setup(){return{data:t(4,30,40),props:e({id:"id",label:"label",children:"children"})}}});return _({render:a},d)}(),"hl-demo5":function(){const{resolveComponent:s,createVNode:o,Fragment:c,openBlock:f,createElementBlock:C}=y;function D(t,d){const n=s("hl-input"),i=s("hl-tree-v2");return f(),C(c,null,[o(n,{modelValue:t.query,"onUpdate:modelValue":d[0]||(d[0]=h=>t.query=h),placeholder:"Please enter keyword",block:"",onInput:t.onQueryChanged},null,8,["modelValue","onInput"]),o(i,{ref:"treeRef",data:t.data,props:t.props,"filter-method":t.filterMethod,height:208},null,8,["data","props","filter-method"])],64)}const{defineComponent:m,ref:a}=y,E=(t,d)=>`${t}-${d}`,e=(t,d,n,i=1,h="node")=>{let l=0;return new Array(n).fill(i).map(()=>{const k=i===t?0:Math.round(Math.random()*d),A=E(h,++l);return{id:A,label:A,children:k?e(t,d,k,i+1,A):void 0}})},r=m({setup(){const t=a(null);return{treeRef:t,data:e(4,30,5),query:a(""),props:a({id:"id",label:"label",children:"children"}),onQueryChanged(d){const n=t.value;n==null||n.filter(d)},filterMethod(d,n){return n.label.indexOf(d)!==-1}}}});return _({render:D},r)}()}},z={class:"doc-main-content"},P={class:"doc-content"},R=u("h1",null,"Tree V2 \u865A\u62DF\u6811",-1),O=u("p",null,"\u4E0D\u8BBA\u4F60\u7684\u6570\u636E\u91CF\u591A\u5927\uFF0C\u865A\u62DF\u6811\u90FD\u80FD\u6BEB\u65E0\u538B\u529B\u5730\u5904\u7406\u3002",-1),Q=u("h2",{id:"ji-chu-yong-fa"},[u("a",{class:"header-anchor",href:"#ji-chu-yong-fa"}),B(" \u57FA\u7840\u7528\u6CD5")],-1),S=u("p",null,"\u57FA\u7840\u7684\u6811\u5F62\u7ED3\u6784\u5C55\u793A",-1),H=u("pre",null,[u("code",{class:"html"},` <template>
...
<\/script>
`)],-1),I=u("h2",{id:"ke-xuan-ze-de-xu-ni-shu"},[u("a",{class:"header-anchor",href:"#ke-xuan-ze-de-xu-ni-shu"}),B(" \u53EF\u9009\u62E9\u7684\u865A\u62DF\u6811")],-1),L=u("p",null,"\u9002\u7528\u4E8E\u9700\u8981\u9009\u62E9\u5C42\u7EA7\u65F6\u4F7F\u7528\u3002",-1),U=u("pre",null,[u("code",{class:"html"},` <template>
  <hl-tree-v2
    :data="data"
    :props="props"
    show-checkbox
...
<\/script>
`)],-1),Y=u("h2",{id:"mo-ren-kuo-zhan-he-mo-ren-jian-cha"},[u("a",{class:"header-anchor",href:"#mo-ren-kuo-zhan-he-mo-ren-jian-cha"}),B(" \u9ED8\u8BA4\u6269\u5C55\u548C\u9ED8\u8BA4\u68C0\u67E5")],-1),Z=u("p",null,"\u6811\u8282\u70B9\u53EF\u4EE5\u5728\u521D\u59CB\u5316\u9636\u6BB5\u88AB\u8BBE\u7F6E\u4E3A\u5C55\u5F00\u6216\u9009\u4E2D\u3002",-1),ee=u("div",null,[u("p",null,[B("\u5206\u522B\u901A\u8FC7 "),u("code",null,"default-expanded-keys"),B(" \u548C "),u("code",null,"default-checked-keys"),B(" \u8BBE\u7F6E\u9ED8\u8BA4\u5C55\u5F00\u548C\u9ED8\u8BA4\u9009\u4E2D\u7684\u8282\u70B9\u3002")])],-1),ue=u("pre",null,[u("code",{class:"html"},` <template>
  <hl-tree-v2
    :data="data"
    :height="208"
    :props="props"
...
<\/script>
`)],-1),te=u("h2",{id:"zi-ding-yi-jie-dian-nei-rong"},[u("a",{class:"header-anchor",href:"#zi-ding-yi-jie-dian-nei-rong"}),B(" \u81EA\u5B9A\u4E49\u8282\u70B9\u5185\u5BB9")],-1),de=u("p",null,"\u8282\u70B9\u7684\u5185\u5BB9\u652F\u6301\u81EA\u5B9A\u4E49\uFF0C\u53EF\u4EE5\u5728\u8282\u70B9\u533A\u6DFB\u52A0\u6309\u94AE\u6216\u56FE\u6807\u7B49\u5185\u5BB9",-1),re=u("pre",null,[u("code",{class:"html"},` <template>
  <hl-tree-v2 :data="data" :props="props" :height="208">
...
`)],-1),ne=u("h2",{id:"jie-dian-guo-lu"},[u("a",{class:"header-anchor",href:"#jie-dian-guo-lu"}),B(" \u8282\u70B9\u8FC7\u6EE4")],-1),oe=u("p",null,"\u6811\u8282\u70B9\u53EF\u4EE5\u8FC7\u6EE4",-1),ae=u("div",null,[u("p",null,"\u5728\u9700\u8981\u5BF9\u8282\u70B9\u8FDB\u884C\u8FC7\u6EE4\u65F6\uFF0C\u8C03\u7528 Tree \u5B9E\u4F8B\u7684filter\u65B9\u6CD5\uFF0C \u53C2\u6570\u4E3A\u5173\u952E\u5B57\u3002 \u9700\u8981\u6CE8\u610F\u7684\u662F\uFF0C\u6B64\u65F6\u9700\u8981\u8BBE\u7F6Efilter-method\uFF0C\u503C\u4E3A\u8FC7\u6EE4\u51FD\u6570\u3002")],-1),le=u("pre",null,[u("code",{class:"html"},` <template>
  <hl-input
    v-model="query"
