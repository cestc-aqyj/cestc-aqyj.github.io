...
<\/script>
`)],-1),W=d("h2",{id:"ren-yi-shi-jian-fan-wei"},[d("a",{class:"header-anchor",href:"#ren-yi-shi-jian-fan-wei"}),c(" \u4EFB\u610F\u65F6\u95F4\u8303\u56F4")],-1),G=d("p",null,[c("\u6DFB\u52A0"),d("code",null,"is-range"),c("\u5C5E\u6027\u5373\u53EF\u9009\u62E9\u65F6\u95F4\u8303\u56F4\uFF0C\u540C\u6837\u652F\u6301"),d("code",null,"arrow-control"),c("\u5C5E\u6027\u3002")],-1),I=d("pre",null,[d("code",{class:"html"},` <template>
  <hl-row align="center" gap="var(--xl)">
    <hl-col span="col-lg-10">
      <hl-time-picker
        v-model="value2"
