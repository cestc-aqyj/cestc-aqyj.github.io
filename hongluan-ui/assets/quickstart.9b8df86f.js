import{P as t,L as o,W as r,Q as s,X as n,S as p,F as h,Y as a,o as e}from"./vue.0e7200cd.js";import{_ as i}from"./index.9dfed6e6.js";import"./hongluan.ccf786f1.js";import"./highlight.e2508551.js";import"./hongluan-icons.9e674cb2.js";const u={},j=s("h1",null,"\u5FEB\u901F\u4E0A\u624B",-1),d=s("p",null,"\u4ECB\u7ECD\u5982\u4F55\u5728\u9879\u76EE\u4E2D\u4F7F\u7528 Hongluan UI\u3002",-1),g=s("h2",{id:"yin-ru-hongluan-ui"},[s("a",{class:"header-anchor",href:"#yin-ru-hongluan-ui"}),a(" \u5F15\u5165 Hongluan UI")],-1),m=s("p",null,"\u4F60\u53EF\u4EE5\u5F15\u5165\u6574\u4E2A Hongluan UI\uFF0C\u6216\u662F\u6839\u636E\u9700\u8981\u4EC5\u5F15\u5165\u90E8\u5206\u7EC4\u4EF6\uFF0C\u6211\u4EEC\u5148\u4ECB\u7ECD\u5982\u4F55\u5F15\u5165\u5B8C\u6574\u7684 Hongluan UI Library\u3002",-1),y=s("h2",{id:"wan-zheng-yin-ru"},[s("a",{class:"header-anchor",href:"#wan-zheng-yin-ru"}),a(" \u5B8C\u6574\u5F15\u5165")],-1),f=s("p",null,"\u5728 main.ts \u4E2D\u5199\u5165\u4EE5\u4E0B\u5185\u5BB9\uFF1A",-1),w=a("main.ts"),b=e(`<pre><code class="hljs language-javascript"><span class="hljs-keyword">import</span> { createApp } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>

<span class="hljs-keyword">import</span> HongluanUI <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;hongluan-ui&#39;</span>; <span class="hljs-comment">//\u5F15\u5165Hongluan </span>
...
</code></pre><p>\u4EE5\u4E0A\u4EE3\u7801\u4FBF\u5B8C\u6210\u4E86 Hongluan UI \u7684\u5F15\u5165\uFF0C\u9700\u8981\u6CE8\u610F\u7684\u662F\u6837\u5F0F\u6587\u4EF6\u9700\u8981\u5355\u72EC\u5F15\u5165\u3002</p><h2 id="volar-support"><a class="header-anchor" href="#volar-support"></a> Volar support</h2><p>\u5982\u679C\u60A8\u4F7F\u7528 Volar\uFF0C\u8BF7\u5728 <code>tsconfig.json</code> \u4E2D\u901A\u8FC7 <code>compilerOptions.type</code> \u6307\u5B9A\u5168\u5C40\u7EC4\u4EF6\u7C7B\u578B\u3002</p>`,4),k=a("tsconfig.json"),v=e(`<pre><code class="hljs language-json">{
  <span class="hljs-attr">&quot;compilerOptions&quot;</span>: {
    <span class="hljs-comment">// ...</span>
    <span class="hljs-attr">&quot;types&quot;</span>: [<span class="hljs-string">&quot;hongluan-ui/global&quot;</span>]
  }
}
</code></pre><h2 id="an-xu-yin-ru-zu-jian"><a class="header-anchor" href="#an-xu-yin-ru-zu-jian"></a> \u6309\u9700\u5F15\u5165\u7EC4\u4EF6</h2><p>HongluanUI \u7684 JavaScript \u4EE3\u7801\u9ED8\u8BA4\u652F\u6301\u57FA\u4E8E ES modules \u7684 <a href="https://webpack.js.org/guides/tree-shaking/">\u6447\u6811 tree shaking</a>\u3002</p>`,3),_=a("app.vue"),x=e(`<pre><code class="hljs language-html"><span class="hljs-tag">&lt;<span class="hljs-name">template</span>&gt;</span>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">head</span>&gt;</span>
</code></pre><h3 id="zi-dong-dao-ru"><a class="header-anchor" href="#zi-dong-dao-ru"></a> \u81EA\u52A8\u5BFC\u5165</h3><p>\u9996\u5148\u9700\u8981\u5B89\u88C5 <code>unplugin-vue-components</code>\u3002</p><pre><code class="hljs language-shell"><span class="hljs-meta">$</span><span class="bash"> npm install unplugin-vue-components</span>
</code></pre><p>\u7136\u540E\u5C06\u4EE5\u4E0B\u4EE3\u7801\u6DFB\u52A0\u5230 <code>Vite</code> \u6216 <code>Webpack</code> \u7684\u914D\u7F6E\u6587\u4EF6\u4E2D\u3002</p>`,11),H=a("vite.config.ts"),z=e(`<pre><code class="hljs language-js"><span class="hljs-keyword">import</span> Components <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;unplugin-vue-components/vite&#39;</span>
...
</code></pre>`,1),I=a("webpack.config.js"),q=e(`<pre><code class="hljs language-js"><span class="hljs-built_in">module</span>.exports = {
  <span class="hljs-comment">/* ... */</span>
  <span class="hljs-attr">plugins</span>: [
...
</code></pre>`,1),C=a("vue.config.js"),S=e(`<pre><code class="hljs language-js"><span class="hljs-built_in">module</span>.exports = {
...
</code></pre><h3 id="vite"><a class="header-anchor" href="#vite"></a> Vite</h3><p>\u9996\u5148\uFF0C\u5B89\u88C5 <a href="https://github.com/anncwb/vite-plugin-style-import">vite-plugin-style-import</a>:</p><pre><code class="hljs language-shell"><span class="hljs-meta">$</span><span class="bash"> npm install vite-plugin-style-import -D</span>
<span class="hljs-meta">#</span><span class="bash">\u6216\u8005</span>
<span class="hljs-meta">$</span><span class="bash"> yarn add vite-plugin-style-import -D</span>
...
app.use(HongluanUI, {
  ...
  <span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">hl-config-provider</span> <span class="hljs-attr">:size</span>=<span class="hljs-string">&quot;size&quot;</span> <span class="hljs-attr">:zIndex</span>=<span class="hljs-string">&quot;zIndex&quot;</span>&gt;</span>
    <span class="hljs-tag">&lt;<span class="hljs-name">app</span> /&gt;</span>
  <span class="hljs-tag">&lt;/<span class="hljs-name">hl-config-provider</span>&gt;</span></span>
&lt;/template&gt;
<span class="xml"><span class="hljs-tag">&lt;<span class="hljs-name">script</span>&gt;</span><span class="javascript">
<span class="hljs-keyword">import</span> { defineComponent } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;vue&#39;</span>
<span class="hljs-keyword">import</span> { HlConfigProvider } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;hongluan-ui&#39;</span>
...
</code></pre><h2 id="kai-shi-shi-yong"><a class="header-anchor" href="#kai-shi-shi-yong"></a> \u5F00\u59CB\u4F7F\u7528</h2><p>\u81F3\u6B64\uFF0C\u4E00\u4E2A\u57FA\u4E8E Vue3 \u548C Hongluan UI \u7684\u5F00\u53D1\u73AF\u5883\u5DF2\u7ECF\u642D\u5EFA\u5B8C\u6BD5\uFF0C\u73B0\u5728\u5C31\u53EF\u4EE5\u7F16\u5199\u4EE3\u7801\u4E86\u3002</p><p>\u5404\u4E2A\u7EC4\u4EF6\u7684\u4F7F\u7528\u65B9\u6CD5\u8BF7\u53C2\u9605\u5B83\u4EEC\u5404\u81EA\u7684\u8BF4\u660E\u6587\u6863\u3002</p>`,40);function A(U,N){const l=t("hl-tag"),c=t("right-nav");return o(),r(h,null,[s("section",null,[j,d,g,m,y,f,s("p",null,[n(l,{type:"danger",effect:"light",class:"border-none border-left border-danger",style:{"--border-left-width":"4px"}},{default:p(()=>[w]),_:1})]),b,s("p",null,[n(l,{type:"danger",effect:"light",class:"border-none border-left border-danger",style:{"--border-left-width":"4px"}},{default:p(()=>[k]),_:1})]),v,s("p",null,[n(l,{type:"danger",effect:"light",class:"border-none border-left border-danger",style:{"--border-left-width":"4px"}},{default:p(()=>[_]),_:1})]),x,s("p",null,[n(l,{type:"danger",effect:"light",class:"border-none border-left border-danger",style:{"--border-left-width":"4px"}},{default:p(()=>[H]),_:1})]),z,s("p",null,[n(l,{type:"danger",effect:"light",class:"border-none border-left border-danger",style:{"--border-left-width":"4px"}},{default:p(()=>[I]),_:1})]),q,s("p",null,[n(l,{type:"danger",effect:"light",class:"border-none border-left border-danger",style:{"--border-left-width":"4px"}},{default:p(()=>[C]),_:1})]),S]),n(c)],64)}var D=i(u,[["render",A]]);export{D as default};
