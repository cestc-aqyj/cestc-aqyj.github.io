...
`;class be{constructor({serializedState:e="",versions:t={vue:"latest",hongluanUI:"latest",hongluanBusinessUI:"latest"}}){c(this,"state");c(this,"compiler");c(this,"options");c(this,"versions");c(this,"pendingCompiler",null);let i={};if(e){const o=JSON.parse(ge(e));for(const r of Object.keys(o))i[r]=new l(r,o[r])}else i={[d]:new l(d,R)};let n=d;i[n]||(n=Object.keys(i)[0]),this.state=S({mainFile:n,files:i,activeFile:i[n],errors:[],vueRuntimeURL:""}),this.versions=t,this.initImportMap()}async init(){await this.setVueVersion(this.versions.vue),this.state.files[v]=new l(v,ve("latest").trim(),!0),V(()=>F(this,this.state.activeFile));for(const e of Object.keys(this.state.files))e!==d&&F(this,this.state.files[e])}setActive(e){this.state.activeFile=this.state.files[e]}addFile(e){this.state.files[e]=new l(e),this.setActive(e)}deleteFile(e){if(e===v){B.warning("You cannot remove it, because Hongluan UI requires it.");return}confirm(`Are you sure you want to delete ${e}?`)&&(this.state.activeFile.filename===e&&(this.state.activeFile=this.state.files[this.state.mainFile]),delete this.state.files[e])}simplifyImportMaps(){const e=this.getImportMap(),t=A({}),i=Object.keys(t);return e.imports=Object.fromEntries(Object.entries(e.imports).filter(([n])=>!i.includes(n))),JSON.stringify(e)}serialize(){const e=JSON.stringify(Object.fromEntries(Object.entries(this.getFiles()).filter(([t])=>t!==v).map(([t,i])=>{if(t==="import-map.json")try{const n=this.simplifyImportMaps();return[t,n]}catch{}return[t,i]})));return`#${fe(e)}`}getFiles(){const e={};for(const t of Object.keys(this.state.files))e[t]=this.state.files[t].code;return e}async setFiles(e,t=d){const i={};t===d&&!e[t]&&(i[t]=new l(t,R));for(const[n,o]of Object.entries(e))i[n]=new l(n,o);for(const n of Object.values(i))await F(this,n);this.state.mainFile=t,this.state.files=i,this.initImportMap(),this.setActive(t)}initImportMap(){this.state.files["import-map.json"]||(this.state.files["import-map.json"]=new l("import-map.json",JSON.stringify({imports:{}},null,2)))}getImportMap(){try{return JSON.parse(this.state.files["import-map.json"].code)}catch(e){return this.state.errors=[`Syntax error in import-map.json: ${e.message}`],{}}}setImportMap(e){this.state.files["import-map.json"].code=JSON.stringify(e,null,2)}addDeps(){const e=this.getImportMap();e.imports=k(k({},e.imports),A({vue:this.versions.vue,hongluanUI:this.versions.hongluanUI,hongluanBusinessUI:this.versions.hongluanBusinessUI})),this.setImportMap(e)}async setVersion(e,t){switch(e){case"hongluanUI":await this.setHongluanUIVersion(t);break;case"hongluanBusinessUI":await this.setHongluanBusinessUIVersion(t);break;case"vue":await this.setVueVersion(t);break}}async setHongluanUIVersion(e){this.versions.hongluanUI=e,this.addDeps()}async setHongluanBusinessUIVersion(e){this.versions.hongluanBusinessUI=e,this.addDeps()}async setVueVersion(e){const{compilerSfc:t,runtimeDom:i}=pe(e);this.pendingCompiler=le(()=>import(t),[]),this.compiler=await this.pendingCompiler,this.pendingCompiler=null,this.state.vueRuntimeURL=i,this.versions.vue=e,this.addDeps(),console.info(`[@vue/repl] Now using Vue version: ${e}`)}}var _e="./assets/logo.c79b58f2.svg",ye=(s,e)=>{const t=s.__vccOpts||s;for(const[i,n]of e)t[i]=n;return t};const Ie={},ke={width:"1.4em",height:"1.4em",viewBox:"0 0 24 24"},we=K('<g fill="none" stroke="#666" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="18" cy="5" r="3"></circle><circle cx="6" cy="12" r="3"></circle><circle cx="18" cy="19" r="3"></circle><path d="M8.59 13.51l6.83 3.98"></path><path d="M15.41 6.51l-6.82 3.98"></path></g>',1),He=[we];function Fe(s,e){return a(),u("svg",ke,He)}var Ee=ye(Ie,[["render",Fe]]);const Ue=p("img",{alt:"logo",src:_e},null,-1),je=p("span",null,"Hongluan Playground",-1),Oe={class:"mr-1"},xe=C({props:{store:null},setup(s){const e="1.0.3",t=S({hongluanUI:{text:"Hongluan UI",published:he(),active:s.store.versions.hongluanUI},hongluanBusinessUI:{text:"Hongluan Business UI",published:me(),active:s.store.versions.hongluanBusinessUI},vue:{text:"Vue",published:de(),active:s.store.versions.vue}});async function i(o,r){t[o].active="loading...",await s.store.setVersion(o,r),t[o].active=r}async function n(){await navigator.clipboard.writeText(location.href),B.success("Sharable URL has been copied to clipboard.")}return(o,r)=>{const b=W,_=G,P=Y;return a(),u("nav",null,[p("h5",null,[Ue,je,p("small",null," ("+E(m(e))+")",1)]),f(P,{class:"links",gap:"var(--md)"},{default:U(()=>[(a(!0),u($,null,D(m(t),(y,O)=>(a(),u("div",{key:O,class:"flex items-center"},[p("span",Oe,E(y.text)+":",1),f(_,{"model-value":y.active,size:"sm",style:{width:"150px"},"onUpdate:modelValue":h=>i(O,h)},{default:U(()=>[(a(!0),u($,null,D(y.published,h=>(a(),Z(b,{key:h,value:h},{default:U(()=>[Q(E(h),1)]),_:2},1032,["value"]))),128))]),_:2},1032,["model-value","onUpdate:modelValue"])]))),128)),p("button",{class:"share",onClick:n},[f(Ee)])]),_:1})])}}});const Se={key:0,class:"antialiased"},Ve={key:1,class:"loading","loading-text":"Loading..."},Be=C({setup(s){const e=X(!0),t={script:{reactivityTransform:!0}},i=new be({serializedState:location.hash.slice(1)});return i.init().then(()=>e.value=!1),ee(),V(()=>history.replaceState({},"",i.serialize())),window.addEventListener("message",n=>{typeof n.data=="string"&&n.data==="loading-finished"&&NProgress.done()},!1),NProgress.start(),(n,o)=>{const r=te;return e.value?ne((a(),u("div",Ve,null,512)),[[r,!0]]):(a(),u("div",Se,[f(xe,{store:m(i)},null,8,["store"]),f(m(se),{ref:"repl",store:m(i),"show-compile-output":"","auto-resize":"","sfc-options":t,"clear-console":!1,onKeydown:[o[0]||(o[0]=L(N(()=>{},["ctrl","prevent"]),["s"])),o[1]||(o[1]=L(N(()=>{},["meta","prevent"]),["s"]))]},null,8,["store"])]))}}});NProgress.configure({showSpinner:!1});ie(Be).mount("#app");
